...
ExternalProject_Add(${PREFIX}
  ...
  UPDATE_COMMAND ""
  PATCH_COMMAND ""
  CMAKE_ARGS -DBUILD_SHARED_LIBS=${NODE_EDITOR_BUILD_SHARED_LIBS} -DBUILD_EXAMPLES=OFF -DBUILD_TESTING=OFF -DCMAKE_INSTALL_PREFIX=${NODE_EDITOR_INSTALL_DIR} -DCMAKE_DEBUG_POSTFIX=${CMAKE_DEBUG_POSTFIX} -DCMAKE_PREFIX_PATH=${CMAKE_PREFIX_PATH}
  TEST_COMMAND ""
)
